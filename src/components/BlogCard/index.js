...
const BlogCard = ({ title, date, hero_image, hero_image_alt, slug }) => {
  ...
  return (
    <Link to={`/blog/${slug}`} className='w-full md:w-1/2 lg:w-1/3 p-3'>
      <div className='' key={title}>
        <div className='p-6 border rounded-xl hover:shadow-sm hover:transition-shadow ease-in-out duration-300'>
          ...
          <span className='inline-block mb-4 text-xs text-gray-600'>
            {date}
          </span>
          <div>
            <h2>
